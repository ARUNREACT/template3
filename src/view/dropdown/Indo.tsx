    ...
    <div className="money">
      ...
      <div className="drop-head">
        <Headslide
          ...
          p2={`With PayPe Indo-Nepal money transfer service, cross-border remittances from India to Nepal have become quick, convenient, and hassle-free. Now, any Nepali citizen working in India can send cash back to their country just by going to their closest Relipay-associated merchant. The merchant will accept cash from any Nepali citizen and then transfer the amount into the beneficiary’s account in Nepal.`}
          headimg={
