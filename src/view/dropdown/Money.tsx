    ...
    <div className="money">
      ...
      <div className="drop-head">
        <Headslide
          ...
          span={"Money Transfer"}
          h1={`Money Transfer`}
          p1={`Money transfer is a crucial and basic need in our day-to-day lives. At Relipay we hope to empower people belonging to the rural and migrant segment of our country by ensuring that this basic need is expertly and conveniently met with the help of our remittance services.`}
          ...
          p3={`We have simplified and streamlined the process of money transfers for the convenience of our customers. Now all the customer has to do is visit their closest Relipay-associated merchant to carry out their transactions. With an ever-expanding network of merchants, we are rapidly eliminating the need of going to the bank for our customers, especially in rural areas.`}
          headimg={
